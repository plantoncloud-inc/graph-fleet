...
async def test_basic_isolation() -> bool:
    ...
    assert creds_1 is not None, "Context 1 credentials should not be None"
    ...
    assert creds_2 is not None, "Context 2 credentials should not be None"
...
async def test_concurrent_operations() -> bool:
    ...
    async def operation_1() -> None:
        ...
        assert creds is not None, "Context 1 credentials should not be None"
    ...
    async def operation_2() -> None:
        ...
        assert creds is not None, "Context 2 credentials should not be None"
...
async def simulate_graph_invocations() -> bool:
    ...
    async def simulate_graph_node(user_id: str, region: str) -> None:
        ...
        assert creds is not None, f"[{user_id}] credentials should not be None"
        print(
            f"[{user_id}] Using credentials: {creds['access_key_id']} in {creds['region']}"
        )
