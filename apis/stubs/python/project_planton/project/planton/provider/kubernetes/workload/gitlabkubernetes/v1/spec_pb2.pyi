...
class GitlabKubernetesSpec(_message.Message):
    __slots__ = ("container", "ingress")
    CONTAINER_FIELD_NUMBER: _ClassVar[int]
    INGRESS_FIELD_NUMBER: _ClassVar[int]
    container: GitlabKubernetesSpecContainer
    ingress: _kubernetes_pb2.IngressSpec
    def __init__(self, container: _Optional[_Union[GitlabKubernetesSpecContainer, _Mapping]] = ..., ingress: _Optional[_Union[_kubernetes_pb2.IngressSpec, _Mapping]] = ...) -> None: ...

class GitlabKubernetesSpecContainer(_message.Message):
    __slots__ = ("resources",)
