...
class ArgocdKubernetesSpec(_message.Message):
    __slots__ = ("container", "ingress")
    CONTAINER_FIELD_NUMBER: _ClassVar[int]
    INGRESS_FIELD_NUMBER: _ClassVar[int]
    container: ArgocdKubernetesArgocdContainer
    ingress: _kubernetes_pb2.IngressSpec
    def __init__(self, container: _Optional[_Union[ArgocdKubernetesArgocdContainer, _Mapping]] = ..., ingress: _Optional[_Union[_kubernetes_pb2.IngressSpec, _Mapping]] = ...) -> None: ...

class ArgocdKubernetesArgocdContainer(_message.Message):
    __slots__ = ("resources",)
