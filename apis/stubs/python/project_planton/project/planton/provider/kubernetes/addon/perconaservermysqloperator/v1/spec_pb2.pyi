...
class PerconaServerMysqlOperatorSpec(_message.Message):
    ...
    namespace: str
    container: PerconaServerMysqlOperatorSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., namespace: _Optional[str] = ..., container: _Optional[_Union[PerconaServerMysqlOperatorSpecContainer, _Mapping]] = ...) -> None: ...

class PerconaServerMysqlOperatorSpecContainer(_message.Message):
    __slots__ = ("resources",)
