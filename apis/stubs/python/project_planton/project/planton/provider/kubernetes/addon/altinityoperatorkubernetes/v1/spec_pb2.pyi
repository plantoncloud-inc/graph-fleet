...
class AltinityOperatorKubernetesSpec(_message.Message):
    ...
    namespace: str
    container: AltinityOperatorKubernetesSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., namespace: _Optional[str] = ..., container: _Optional[_Union[AltinityOperatorKubernetesSpecContainer, _Mapping]] = ...) -> None: ...

class AltinityOperatorKubernetesSpecContainer(_message.Message):
    __slots__ = ("resources",)
