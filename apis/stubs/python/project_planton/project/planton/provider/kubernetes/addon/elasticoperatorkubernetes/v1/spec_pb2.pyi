...
class ElasticOperatorKubernetesSpec(_message.Message):
    ...
    container: ElasticOperatorKubernetesSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., container: _Optional[_Union[ElasticOperatorKubernetesSpecContainer, _Mapping]] = ...) -> None: ...

class ElasticOperatorKubernetesSpecContainer(_message.Message):
    __slots__ = ("resources",)
