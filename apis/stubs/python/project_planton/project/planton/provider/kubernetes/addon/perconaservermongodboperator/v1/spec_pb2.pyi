...
class PerconaServerMongodbOperatorSpec(_message.Message):
    __slots__ = ("target_cluster", "namespace", "container")
    TARGET_CLUSTER_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    CONTAINER_FIELD_NUMBER: _ClassVar[int]
    target_cluster: _target_cluster_pb2.KubernetesAddonTargetCluster
    namespace: str
    container: PerconaServerMongodbOperatorSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., namespace: _Optional[str] = ..., container: _Optional[_Union[PerconaServerMongodbOperatorSpecContainer, _Mapping]] = ...) -> None: ...

class PerconaServerMongodbOperatorSpecContainer(_message.Message):
    __slots__ = ("resources",)
