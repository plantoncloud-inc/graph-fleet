...
class DigitalOceanDnsZoneSpec(_message.Message):
    __slots__ = ("domain_name", "records")
    DOMAIN_NAME_FIELD_NUMBER: _ClassVar[int]
    RECORDS_FIELD_NUMBER: _ClassVar[int]
    domain_name: str
    records: _containers.RepeatedCompositeFieldContainer[DigitalOceanDnsZoneRecord]
    def __init__(self, domain_name: _Optional[str] = ..., records: _Optional[_Iterable[_Union[DigitalOceanDnsZoneRecord, _Mapping]]] = ...) -> None: ...

class DigitalOceanDnsZoneRecord(_message.Message):
