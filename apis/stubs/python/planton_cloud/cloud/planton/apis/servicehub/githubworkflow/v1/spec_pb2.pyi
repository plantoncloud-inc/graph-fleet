...
class GithubWorkflowSpec(_message.Message):
    ...
    is_official: bool
    is_ready: bool
    git_repo: GithubWorkflowGitRepo
    def __init__(self, selector: _Optional[_Union[_selector_pb2.ApiResourceSelector, _Mapping]] = ..., description: _Optional[str] = ..., is_official: bool = ..., is_ready: bool = ..., git_repo: _Optional[_Union[GithubWorkflowGitRepo, _Mapping]] = ...) -> None: ...

class GithubWorkflowGitRepo(_message.Message):
