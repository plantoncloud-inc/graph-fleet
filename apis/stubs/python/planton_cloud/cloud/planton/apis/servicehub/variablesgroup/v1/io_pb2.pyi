...
from cloud.planton.apis.servicehub.variablesgroup.v1 import api_pb2 as _api_pb2
from cloud.planton.apis.servicehub.variablesgroup.v1 import spec_pb2 as _spec_pb2
...
class VariablesGroupId(_message.Message):
    __slots__ = ("value",)
    VALUE_FIELD_NUMBER: _ClassVar[int]
    value: str
    def __init__(self, value: _Optional[str] = ...) -> None: ...

class TransformConfigKeysRequest(_message.Message):
...
class TransformConfigKeysResponse(_message.Message):
...
class UpsertVariableRequest(_message.Message):
    __slots__ = ("group_id", "entry")
    GROUP_ID_FIELD_NUMBER: _ClassVar[int]
    ENTRY_FIELD_NUMBER: _ClassVar[int]
    group_id: str
    entry: _spec_pb2.VariablesGroupEntry
    def __init__(self, group_id: _Optional[str] = ..., entry: _Optional[_Union[_spec_pb2.VariablesGroupEntry, _Mapping]] = ...) -> None: ...
...
class GetVariableValueRequest(_message.Message):
...
class VariablesGroupList(_message.Message):
    __slots__ = ("total_pages", "entries")
    TOTAL_PAGES_FIELD_NUMBER: _ClassVar[int]
    ENTRIES_FIELD_NUMBER: _ClassVar[int]
    total_pages: int
    entries: _containers.RepeatedCompositeFieldContainer[_api_pb2.VariablesGroup]
    def __init__(self, total_pages: _Optional[int] = ..., entries: _Optional[_Iterable[_Union[_api_pb2.VariablesGroup, _Mapping]]] = ...) -> None: ...
