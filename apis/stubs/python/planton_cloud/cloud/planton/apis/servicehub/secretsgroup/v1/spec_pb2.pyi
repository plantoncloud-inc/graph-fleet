...
class SecretsGroupSpec(_message.Message):
    __slots__ = ("description", "entries")
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ENTRIES_FIELD_NUMBER: _ClassVar[int]
    description: str
    entries: _containers.RepeatedCompositeFieldContainer[SecretsGroupEntry]
    def __init__(self, description: _Optional[str] = ..., entries: _Optional[_Iterable[_Union[SecretsGroupEntry, _Mapping]]] = ...) -> None: ...

class SecretsGroupEntry(_message.Message):
