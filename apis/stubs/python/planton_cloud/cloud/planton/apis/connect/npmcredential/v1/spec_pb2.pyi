...
class NpmCredentialSpec(_message.Message):
    ...
    gcp_artifact_registry: NpmCredentialGcpArtifactRegistry
    jfrog_artifactory: NpmCredentialJfrogArtifactory
    github_packages: NpmCredentialGithubPackages
    def __init__(self, provider: _Optional[_Union[MavenRepoProvider, str]] = ..., gcp_artifact_registry: _Optional[_Union[NpmCredentialGcpArtifactRegistry, _Mapping]] = ..., jfrog_artifactory: _Optional[_Union[NpmCredentialJfrogArtifactory, _Mapping]] = ..., github_packages: _Optional[_Union[NpmCredentialGithubPackages, _Mapping]] = ...) -> None: ...

class NpmCredentialGcpArtifactRegistry(_message.Message):
...
class NpmCredentialJfrogArtifactory(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class NpmCredentialGithubPackages(_message.Message):
