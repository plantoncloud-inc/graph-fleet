...
class KubernetesClusterCredentialSpec(_message.Message):
    ...
    gcp_gke: KubernetesClusterCredentialGcpGke
    aws_eks: KubernetesClusterCredentialAwsEks
    azure_aks: KubernetesClusterCredentialAzureAks
    digital_ocean_doks: KubernetesClusterCredentialDigitalOceanDoks
    def __init__(self, provider: _Optional[_Union[KubernetesProvider, str]] = ..., gcp_gke: _Optional[_Union[KubernetesClusterCredentialGcpGke, _Mapping]] = ..., aws_eks: _Optional[_Union[KubernetesClusterCredentialAwsEks, _Mapping]] = ..., azure_aks: _Optional[_Union[KubernetesClusterCredentialAzureAks, _Mapping]] = ..., digital_ocean_doks: _Optional[_Union[KubernetesClusterCredentialDigitalOceanDoks, _Mapping]] = ...) -> None: ...

class KubernetesClusterCredentialGcpGke(_message.Message):
...
class KubernetesClusterCredentialAwsEks(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class KubernetesClusterCredentialAzureAks(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class KubernetesClusterCredentialDigitalOceanDoks(_message.Message):
