...
class GcpCredentialQueryControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get = channel.unary_unary(
                '/cloud.planton.apis.connect.gcpcredential.v1.GcpCredentialQueryController/get',
        ...
        self.find = channel.unary_unary(
                '/cloud.planton.apis.connect.gcpcredential.v1.GcpCredentialQueryController/find',
                ...
                response_deserializer=cloud_dot_planton_dot_apis_dot_connect_dot_gcpcredential_dot_v1_dot_io__pb2.GcpCredentialList.FromString,
                _registered_method=True)


class GcpCredentialQueryControllerServicer(object):
    """gcp-credential query controller
    """
    ...
    def find(self, request, context):
        """find gcp-credentials with pagination and filtering
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GcpCredentialQueryControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'find': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=cloud_dot_planton_dot_apis_dot_connect_dot_gcpcredential_dot_v1_dot_io__pb2.GcpCredentialList.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cloud.planton.apis.connect.gcpcredential.v1.GcpCredentialQueryController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cloud.planton.apis.connect.gcpcredential.v1.GcpCredentialQueryController', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class GcpCredentialQueryController(object):
    """gcp-credential query controller
    """
    ...
    def find(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            cloud_dot_planton_dot_apis_dot_connect_dot_gcpcredential_dot_v1_dot_io__pb2.GcpCredentialList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
