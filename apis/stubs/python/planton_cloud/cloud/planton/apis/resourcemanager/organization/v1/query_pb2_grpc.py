...
class OrganizationQueryControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get = channel.unary_unary(
                '/cloud.planton.apis.resourcemanager.organization.v1.OrganizationQueryController/get',
        ...
        self.find = channel.unary_unary(
                '/cloud.planton.apis.resourcemanager.organization.v1.OrganizationQueryController/find',
                ...
                response_deserializer=cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.OrganizationList.FromString,
                _registered_method=True)
        self.findOrganizations = channel.unary_unary(
                '/cloud.planton.apis.resourcemanager.organization.v1.OrganizationQueryController/findOrganizations',
                request_serializer=cloud_dot_planton_dot_apis_dot_commons_dot_protobuf_dot_custom__pb2.CustomEmpty.SerializeToString,
                response_deserializer=cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.Organizations.FromString,
                _registered_method=True)
...
def add_OrganizationQueryControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'find': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.OrganizationList.SerializeToString,
            ),
            'findOrganizations': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.Organizations.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cloud.planton.apis.resourcemanager.organization.v1.OrganizationQueryController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cloud.planton.apis.resourcemanager.organization.v1.OrganizationQueryController', rpc_method_handlers)
...
class OrganizationQueryController(object):
    ...
    def find(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.OrganizationList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def findOrganizations(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            cloud_dot_planton_dot_apis_dot_resourcemanager_dot_organization_dot_v1_dot_io__pb2.Organizations.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
