...
class CreateMachineAccessTokenInput(_message.Message):
    __slots__ = ("machine_account_email", "client_secret")
    MACHINE_ACCOUNT_EMAIL_FIELD_NUMBER: _ClassVar[int]
    CLIENT_SECRET_FIELD_NUMBER: _ClassVar[int]
    machine_account_email: str
    client_secret: str
    def __init__(self, machine_account_email: _Optional[str] = ..., client_secret: _Optional[str] = ...) -> None: ...
...
class GithubUsername(_message.Message):
    __slots__ = ("value",)
    VALUE_FIELD_NUMBER: _ClassVar[int]
    value: str
    def __init__(self, value: _Optional[str] = ...) -> None: ...
