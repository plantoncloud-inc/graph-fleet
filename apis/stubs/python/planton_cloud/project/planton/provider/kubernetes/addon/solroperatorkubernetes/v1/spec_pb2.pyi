...
class SolrOperatorKubernetesSpec(_message.Message):
    ...
    container: SolrOperatorKubernetesSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., container: _Optional[_Union[SolrOperatorKubernetesSpecContainer, _Mapping]] = ...) -> None: ...

class SolrOperatorKubernetesSpecContainer(_message.Message):
    __slots__ = ("resources",)
