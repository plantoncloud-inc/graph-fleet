...
class PerconaPostgresqlOperatorSpec(_message.Message):
    ...
    namespace: str
    container: PerconaPostgresqlOperatorSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., namespace: _Optional[str] = ..., container: _Optional[_Union[PerconaPostgresqlOperatorSpecContainer, _Mapping]] = ...) -> None: ...

class PerconaPostgresqlOperatorSpecContainer(_message.Message):
    __slots__ = ("resources",)
