...
class IstioKubernetesSpec(_message.Message):
    ...
    container: IstioKubernetesSpecContainer
    def __init__(self, target_cluster: _Optional[_Union[_target_cluster_pb2.KubernetesAddonTargetCluster, _Mapping]] = ..., container: _Optional[_Union[IstioKubernetesSpecContainer, _Mapping]] = ...) -> None: ...

class IstioKubernetesSpecContainer(_message.Message):
    __slots__ = ("resources",)
