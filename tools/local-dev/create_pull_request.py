#!/usr/bin/env python3
"""
Deterministic PR creation utility for Graph Fleet.
...
Example:
  python3 tools/local-dev/create_pull_request.py \
    --title "feat(agents/rds_manifest_generator): add schema validation" \
    --branch-name "feat/agents-rds_manifest_generator-add-schema-validation" \
    --commit-message "feat(agents/rds_manifest_generator): add schema validation" \
    --body-file /path/to/body.md \
    --reviewers user1,user2 --labels "agents,enhancement"
"""
